...
###################################################
### code chunk number 11: flup.rnw:284-291
###################################################
library(popEpi)
...
###################################################
### code chunk number 12: flup.rnw:302-305
###################################################
identical( dmS2, dmM )
class( dmS2 )
class( dmM )
...
###################################################
### code chunk number 13: flup.rnw:335-342
###################################################
...
###################################################
### code chunk number 14: flup.rnw:357-364
###################################################
...
###################################################
### code chunk number 15: flup.rnw:389-390
###################################################
...
###################################################
### code chunk number 17: flup.rnw:433-441
###################################################
...
###################################################
### code chunk number 18: flup.rnw:477-478
###################################################
summary( (dmS2$age-dmS2$tfD) - (dmS2$dodm-dmS2$dobth) ) 


###################################################
### code chunk number 19: flup.rnw:483-485
###################################################
...
###################################################
### code chunk number 20: flup.rnw:590-592
###################################################
...
###################################################
### code chunk number 21: flup.rnw:614-619
###################################################
...
###################################################
### code chunk number 22: flup.rnw:635-640
###################################################
...
###################################################
### code chunk number 23: flup.rnw:659-662
###################################################
...
###################################################
### code chunk number 24: flup.rnw:670-672
###################################################
...
###################################################
### code chunk number 25: flup.rnw:675-676
###################################################
attr( Xa, "Lexis" )


###################################################
### code chunk number 26: flup.rnw:685-686
###################################################
...
###################################################
### code chunk number 29: flup.rnw:737-741
###################################################
...
###################################################
### code chunk number 30: flup.rnw:755-759
###################################################
pm <- glm( cbind(lex.Xst=="Dead",lex.dur) ~ Ns(age,knots=a.kn) 
                                          + Ns(tfI,knots=i.kn) 
                                          + lex.Cst + sex,
...
###################################################
### code chunk number 31: flup.rnw:765-771
###################################################
...
###################################################
### code chunk number 32: flup.rnw:777-778
###################################################
...
###################################################
### code chunk number 34: flup.rnw:815-819
###################################################
library( survival )
...
###################################################
### code chunk number 35: flup.rnw:823-826
###################################################
...
###################################################
### code chunk number 36: flup.rnw:835-838
###################################################
...
###################################################
### code chunk number 39: flup.rnw:944-949
###################################################
...
###################################################
### code chunk number 40: flup.rnw:959-969
###################################################
...
###################################################
### code chunk number 41: flup.rnw:984-985
###################################################
...
###################################################
### code chunk number 46: flup.rnw:1108-1121
###################################################
dmd <- glm.Lexis( dmCs,
                  from="DM", to="Dead",
                  formula = ~ Ns(age,knots=a.kn) 
...
###################################################
### code chunk number 49: flup.rnw:1167-1175
###################################################
...
###################################################
### code chunk number 51: flup.rnw:1205-1213
###################################################
dmM <- mcutLexis( dmL,
             timescale = "per",
                    wh = c("doins","dooad"), 
...
###################################################
### code chunk number 52: flup.rnw:1217-1221
###################################################
